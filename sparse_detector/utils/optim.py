...
class StepLRExcludeAlpha(lr_scheduler.StepLR):
    ...
    """
    def __init__(self, optimizer: Optimizer, step_size: int, gamma: float = 0.1, last_epoch: int = -1, verbose: bool = False, exclude_alpha: bool = True) -> None:
